...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  private static final String OBJECT_DETECTION = "物体识别";
  private static final String OBJECT_DETECTION_CUSTOM = "自定义物体识别";
  private static final String CUSTOM_AUTOML_OBJECT_DETECTION =
      "Custom AutoML Object Detection (Flower)";
  private static final String FACE_DETECTION = "面部识别";
  private static final String BARCODE_SCANNING = "二维码扫描";
  private static final String IMAGE_LABELING = "Image Labeling";
  private static final String IMAGE_LABELING_CUSTOM = "Custom Image Labeling (Birds)";
  private static final String CUSTOM_AUTOML_LABELING = "Custom AutoML Image Labeling (Flower)";
  private static final String POSE_DETECTION = "姿态识别";
  private static final String SELFIE_SEGMENTATION = "自拍人脸分割";
  private static final String TEXT_RECOGNITION_LATIN = "文字识别（拉丁文）";
  private static final String TEXT_RECOGNITION_CHINESE = "文字识别（中文）";
  private static final String TEXT_RECOGNITION_DEVANAGARI = "文字识别（梵文）";
  private static final String TEXT_RECOGNITION_JAPANESE = "文字识别（日文）";
  private static final String TEXT_RECOGNITION_KOREAN = "文字识别（韩文）";
  private static final String FACE_MESH_DETECTION = "Face Mesh Detection (Beta)";

  private static final String TAG = "实时检测";
